...
<<<<<<< HEAD:resources/views/solicitud.blade.php
        <!--Autorizadores-->
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <input class="border border-success" id="funcion" name="funcion" type="text"
                        placeholder=" Coloca tus funciones" value="{{ old('funcion') }}" />
                </div>
            </div>
            <br>
			<br>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <input class="border-success" id="modelo" name="modelo" type="text" placeholder=" Modelo "
                        value="{{ old('modelo') }}" />
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-3">
                    <input class="border-success" id="mac" name="mac" type="text" placeholder=" MAC "
                        value="{{ old('mac') }}" />
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-3">
                    <input class="border-success" id="ip_antigua" name="ip_antigua" type="text"
                        placeholder=" IP Antigua " value="{{ old('ip_antigua') }}" />
                </div>
            </div>
            <br>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <input class="btn btn-primary btn-lg active" onclick="alert('¿Desea enviar la solicitud?')" type="submit" value="Enviar solicitud">
                </div>
                <div class="col-md-5">
                    <!--
...
>>>>>>> a9b4b4fadd266510365bb363af974d27f16c4d44:resources/views/users/solicitud/solicitud.blade.php
